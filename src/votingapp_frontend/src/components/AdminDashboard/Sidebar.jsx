...
const menuItems = [
  ...
  { icon: Vote, label: 'Kelola Pemilihan', href: '/kelola-pemilihan' },
  { icon: BarChart3, label: 'Hasil Pemilihan', href: '/hasil-pemilihan' },
  { icon: TrendingUp, label: 'Laporan & Arsip', href: '/laporan-arsip' },
  { icon: Users, label: 'Manajemen Pengguna', href: '/manajemen-pengguna' },
  { icon: Volume2, label: 'Notifikasi & Broadcast', href: '/notifikasi-broadcast' },
  { icon: Settings, label: 'Pengaturan Sistem', href: '/pengaturan-sistem' },
];
